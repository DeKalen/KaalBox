        ...
        static void Main(string[] args)
        {
            ...
            {   Apen:
                Console.WriteLine("Welkom bij Na-apen klik op enter om te beginnen");
                        ...
                        Console.WriteLine("typ opnieuw om terug te gaan of typ andere om de andere opties te kiezen of typ weg om weg te gaan");
            ...
            else if (spelOptie == "dobbelsteen")
            {
                ...
                if (dobbelEen == "1")
                {
                    ...
                    Console.WriteLine("\ntyp opnieuw om terug te gaan of typ andere om de andere opties te kiezen of\ntyp dobbelsteen om de andere dobbelsteen opties te kiezen of typ weg om weg te gaan");
                ...
                else if (dobbelEen == "2")
                {
                    Console.WriteLine("Je koos 2 dobbelstenen, klik enter om te beginnen");
                            ...
                            else if (dobbeloptie02 == "weg")
                            {
                                goto Einde;
                            }
                }
            }
            else if (spelOptie == "rekenmachine")
            {
                Reken:
                double num01;
                double num02;
                ...
                if (rekenOptie == "*")
                {
                    ...
                    Console.WriteLine("\nOm opnieuw te rekenen typ opnieuw , Om andere opties te kijken typ andere , Om weg te gaan typ weg");
                    string rekenEinde = Console.ReadLine();
                    if (rekenEinde == "opnieuw")
                    {
                        goto Reken;
                    }
                    else if (rekenEinde == "andere")
                    {
                        goto Optie;
                    }
                    else if (rekenEinde == "weg")
                    {
                        goto Einde;
                    }
                }
                else if (rekenOptie == "-")
                {
                    ...
                    Console.WriteLine("\nOm opnieuw te rekenen typ opnieuw , Om andere opties te kijken typ andere\nOm weg te gaan typ weg");
                ...
                else if (rekenOptie == "+")
                {
                    ...
                    if (rekenEinde02 == "opnieuw")
                    {
                        goto Reken;
                    }
                    else if (rekenEinde02 == "andere")
                    {
                        goto Optie;
                    }
                    else if (rekenEinde02 == "weg")
                    {
                        goto Einde;
                    }
                }
                else if (rekenOptie == "/")
                {
                    ...
                    if (rekenEinde03 == "opnieuw")
                    {
                        goto Reken;
                    }
                    else if (rekenEinde03 == "andere")
                    {
                        goto Optie;
                    }
                    else if (rekenEinde03 == "weg")
                    {
                        goto Einde;
                    }
                }
